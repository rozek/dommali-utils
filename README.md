...
At most one specific recognizer may be installed in any `dommali` object.
...
Multiple delegated recognizers with different selectors may be installed in any `dommali` object - but at most one per selector.
